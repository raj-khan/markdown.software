...
function RegistrationMark({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" aria-hidden="true">
      <circle cx="10" cy="10" r="5" fill="none" stroke="var(--color-rust)" strokeWidth="1.25" />
      <line x1="10" y1="0" x2="10" y2="20" stroke="var(--color-rust)" strokeWidth="1.25" />
      <line x1="0" y1="10" x2="20" y2="10" stroke="var(--color-rust)" strokeWidth="1.25" />
    </svg>
  );
}
